...
path_to_project = '/home/' +os.environ['USER'] + '/LightningTree/'
p = None
...
def start_subprocess():
    ...
    if p is None:
        ...
        p = subprocess.Popen([path_to_project + "/LightningTree"], stdout = subprocess.PIPE, stdin = subprocess.PIPE, stderr = subprocess.STDOUT)
...
app.layout = html.Div([html.H1("Моделирование молнии", style={'textAlign': 'center', 'color': 'gold'}),
                    ...
                    dcc.Interval(id='interval-component', interval=10, n_intervals=0, disabled=disable),
